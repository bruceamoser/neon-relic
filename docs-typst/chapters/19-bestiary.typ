// ============================================================
// CH-19: Bestiary
// Source: docs/chapters/19-bestiary.adoc
// ============================================================

#import "../lib/theme.typ": *
#import "../lib/components.typ": *

#chapter-header("19", "Bestiary")
...
- *Fear Rating* applies to supernatural entities and rare humans. 0 = no Fear check triggered. See the Corruption, Fear & Healing chapter.
...
- Artifacts and what spawns Constructs: see the Artifacts chapter.
- Corruption gain from supernatural sources: see the Corruption, Fear & Healing chapter.
...
#nr-table(
  caption: "The Mire: Psychic Contamination Zone",
  columns: (1fr, 3fr),
  [Attribute], [Value],
...
*Motivation:* The Hollow protects the artifact, returns it to its last owner, or pursues the last living person it was "tasked" to reach. The DA determines the simple directive at the moment of the Hollow's creation.
...
#nr-table-wide(
  caption: "NPC Corruption Thresholds",
  columns: (1fr, 2fr, 4fr),
...
#nr-table-wide(
  caption: "NPC Attribute Baselines",
