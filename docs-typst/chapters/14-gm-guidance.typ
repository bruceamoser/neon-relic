...
#nr-table-wide(
  caption: "The Five-Element Mystery Structure",
  columns: (1fr, 2fr, 4fr),
...
#nr-table-wide(
  caption: "Example Countdown Clock",
  columns: (1fr, 3fr, 3fr),
...
#nr-table-wide(
  caption: "Supernatural Entity Behavior",
  columns: (1fr, 4fr),
...
#nr-table-wide(
  caption: "1980s Investigation Complication Table (D12)",
  columns: (1fr, 4fr),
  [*D12*], [*Complication*],
...
#nr-table-wide(
  caption: "Containment Objective Design",
  columns: (2fr, 4fr),
