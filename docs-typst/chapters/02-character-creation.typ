...
#nr-table-wide(
  caption: "Attribute Points by Age Group",
  columns: (1fr, 1fr, 4fr),
...
#nr-table-wide(
  caption: "Skill Points by Age Group",
...
#nr-table-wide(
  caption: "Division Signature Items",
  columns: (1fr, 2fr, 4fr),
...
#nr-table(
  caption: "Character Sheet Checklist",
  columns: (1fr, 2fr),
  [*Field*], [*Notes*],
...
#nr-table-wide(
  caption: "Example: Petra's Attributes",
  columns: (1fr, 1fr, 1fr),
...
#nr-table-wide(
  caption: "Example: Petra's Skills",
  columns: (1fr, 1fr, 1fr),
...
#nr-table(
  caption: "Example: Petra's Starting Statistics",
  columns: (1fr, 1fr),
  [*Statistic*], [*Value*],
  [Clearance Level], [2],
  [Corruption], [0],
