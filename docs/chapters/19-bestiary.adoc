...
The Corruption thresholds from `docs/chapters/08-corruption-fear-healing.adoc` apply to NPCs as well as agents. For simplicity, the GM tracks NPC corruption with a three-stage shorthand:
