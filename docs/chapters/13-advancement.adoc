...
> *Note:* Clearance Level is no longer purchased directly with XP. To increase CL, purchase the *Requisition Authority* general talent (6 XP, repeatable). See the General Talents list below.
