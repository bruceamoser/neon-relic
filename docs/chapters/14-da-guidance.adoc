...
The new Case File structure is built as a *case board*: Locations, NPC Cards, Information Cards, organizations, relic milestones, and delayed returns tracked on the Operations Board.
...
*See also:* xref:chapters/15-case-file.adoc#chapter-case-file[Case Files], xref:chapters/11-artifacts.adoc#chapter-artifacts[Artifacts], xref:chapters/17-rival-factions.adoc#chapter-rival-factions[Rival Factions], xref:chapters/19-bestiary.adoc#chapter-bestiary[Bestiary], xref:chapters/08-corruption-fear-healing.adoc#chapter-corruption[Corruption, Fear & Healing].
