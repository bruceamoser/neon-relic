...
Fria Ligan AB ("Free League") has created the attached Year Zero Engine System Reference Document ("YZE SRD").

You may use the YZE SRD to create your own tabletop role playing game, subject to the terms of this license agreement. By using the YZE SRD, you agree to these terms.
