...
[%header,cols="2,^1,2,3,3,2"]
|===
| Artifact | Die | Mundane Appearance | Effect | Cost & Fracture | Emission
...
| 3–4 | Step down two dice from current | Barely active; only works on activation rolls of 5–6
