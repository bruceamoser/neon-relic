...
The table's facilitator role (formerly "GM" in generic systems). The DA presents scenes, adjudicates uncertainty, advances clocks, and portrays the world and opposition. See xref:14-gm-guidance.adoc[Director of Agents Guidance].
