...
*Anchor*::
A physical object linked to a humanizing memory. Once per session, a character may interact with their Anchor to heal 1d4 Corruption. See xref:07-corruption.adoc#_anchors[Anchors].
