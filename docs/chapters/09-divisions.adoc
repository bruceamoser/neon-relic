...
| *Requisition Expert* | +1 Corruption | During the Equipping Phase, automatically acquire any one non-artifact item without spending from your CL Pool. This item is in addition to your normal CL-pool allocation. You may still make an above-CL requisition roll for a different item if desired.
