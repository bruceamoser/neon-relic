...
| *Containment Protocol* | +1 Corruption | Quickly improvise a ward using mundane materials (salt, copper wire). Any supernatural entity must make a *Strength (Force) roll at Difficulty 2* to cross it.
...
| *Sanctuary Master* | — | When inside Covenant HQ, automatically succeed on any Lore (Wits) roll regarding the history of a contained artifact.
