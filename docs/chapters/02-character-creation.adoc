...
> **Clearance Level (CL) vs. Covenant Standing — they are not the same thing.**
>
> | | *Clearance Level (CL)* | *Covenant Standing*
> | *What it is* | Equipment authorization tier | Institutional reputation and trust
> | *How it changes* | Division base + Age Group modifier (min 1, max 5) | Earned via mission success; reduced by exposure or failure
> | *What it gates* | Gear requisitions during Equipping Phase | Information access, advanced facilities, some talent prerequisites
> | *Defined in* | This chapter (Step 3) | xref:chapters/12-headquarters.adoc#covenant-standing[Headquarters]
>
> High CL means your agent is trusted with expensive or dangerous equipment. High Standing means the Covenant trusts your agent's *judgment*. Both matter, but they increase through different actions and govern different systems.
