...
> *Clearance Level (CL)* determines what equipment your agent can requisition from Stack during the Equipping Phase — nothing else. Information access and institutional trust are governed by Covenant Standing (see xref:chapters/12-headquarters.adoc#covenant-standing[Covenant Standing]). Your final CL equals your Division's base CL plus your Age Group modifier (minimum 1, maximum 5).
