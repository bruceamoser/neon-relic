...
* 1× sidearm _(optional — Wardens only. Wardens are pre-authorized for a CL 3 sidearm because they perform physical vault security and field escort operations. Catalogers, Internal CI, and Stack agents must requisition a sidearm normally against their standard CL.)_
...
* **Divisions and talent lists:** xref:chapters/09-divisions.adoc#chapter-divisions[Divisions]
* **Background Talents, General Talents, Dark Secret rules:** xref:chapters/13-advancement.adoc#chapter-advancement[Advancement, Talents, and Dark Secrets]
* **Clearance Level requisition rules:** xref:chapters/12-headquarters.adoc#covenant-standing[Headquarters — Covenant Standing]
* **Attributes as damage pools, Broken state, healing:** xref:chapters/07-health-damage-armor.adoc#chapter-health[Health, Damage & Armor]
* **Anchor mechanics and Corruption healing:** xref:chapters/08-corruption-fear-healing.adoc#chapter-corruption[Corruption, Fear & Healing]
* **Corruption full rules and economy:** xref:chapters/08-corruption-fear-healing.adoc#chapter-corruption[Corruption, Fear & Healing]
