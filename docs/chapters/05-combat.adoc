...
* *Attacking vehicles:* To disable a vehicle, attack it using Force (melee) or Firearms (ranged) against Difficulty 1. Damage is applied as Wear after subtracting the vehicle's Armor Rating (each point of damage that exceeds armor = 1 Wear). At 5 Wear, the vehicle is disabled.
