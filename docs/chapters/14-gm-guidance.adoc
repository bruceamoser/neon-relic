...
| *Rival Faction* | Who else wants the artifact? | Even low-stakes cases should have a second party. The Vantablack Compact, MJ-12, the Hellfire Consortium, or a true-believer group such as the Ember Accord. Rival factions create competing agendas and prevent simple extraction.
...
* Case File structure (8-phase structure, Countdown mechanics): xref:chapters/15-case-file.adoc#chapter-case-file[Case Files]
