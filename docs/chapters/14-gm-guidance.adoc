...
The new Case File structure is built around an *Operations Board*: Locations, NPC Cards, Information Cards, organizations, relic milestones, and delayed returns tracked on the Operations Board.
...
Every significant NPC gets an *NPC Card* with the following fields, matching the NPC Cards described in xref:chapters/15-case-file.adoc#chapter-case-file[Case Files].
...
Containment rituals are intentionally unstandardized.
...
The base mechanics (Lore rolls, Difficulty modifiers, Decay advancement) are provided in xref:chapters/11-artifacts.adoc#containment-rituals[Chapter 11 — Artifacts].
