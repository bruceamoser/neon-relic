...
* one or more *fronts* representing external reactive pressure
...
| *Key Activity*
| Scene metadata determined by the DA. It states what the scene is trying to accomplish immediately, regardless of how the players approach it.
|===
...
. *Advance consequences.* Worsen any fronts or the relic timeline triggered by time passage, loud action, public exposure, missed windows, packet interception, or artifact mishandling.
...
Not every contribution requires a roll. Roll only when the outcome is uncertain and the consequence matters. The Key Activity normally requires at least one meaningful roll. Support rolls matter when failure would expose the team, cost time, or worsen a front.
...
| *Progress With Cost*
| The team gets the main thing, but a front worsens, a witness is spooked, a route closes, or someone takes +1 Corruption from exposure.
...
| *Breach*
| The scene goes loud, public, or occultly unstable. A front or relic timeline worsens immediately, and the next shift starts under pressure.
|===

---

== Fronts and Relic Timeline

Every case should distinguish between what *other people* are doing and what the *artifact* is doing.

=== Fronts

A *front* is external reactive pressure. Examples:
...
Fronts respond to agent action, visible anomalies, publicity, money movement, faction paranoia, and missed opportunities.
...
Do not say: "That front advanced from 6 to 4" unless your table explicitly prefers open tracking.
...
| *Risked Fronts*
| Which fronts or relic timeline tracks are most likely to worsen if things go poorly or loudly.
...
* DA guidance for authoring fronts, relic timelines, and scene networks: xref:chapters/14-gm-guidance.adoc#chapter-gm-guidance[Director of Agents Guidance]
...
. **Roll d6 on Complication.** Turn it into either a front or a modifier on an existing front.
...
>
> **Front:** The journalist's article runs Friday morning. If the artifact is not secured
