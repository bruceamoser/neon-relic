...
The Covenant operates in an era of paper maps, wrong turns, dead payphones, and long stretches of road where no one can help quickly. Travel is not a detached mini-game. It is a *shift type* inside the case engine.
...
* *Car or motorcycle:* WIT (Investigate) to read the route, Difficulty 1 in clear conditions, 2 at night or in weather, 3 under pursuit or in unfamiliar territory.
* *Foot or urban transit:* AGI (Sneak) to move without drawing attention, Difficulty 1 normally, 2 in hostile areas.
* *Charter flight or helicopter:* WIT (Tech) to coordinate with the pilot or operate comms, Difficulty 2.
...
| 11 | *Fuel Stop.* The team must stop for gas (or food, or rest). A short public window of vulnerability opens. Sneak (Difficulty 1) to transit without being noted by anyone watching.
