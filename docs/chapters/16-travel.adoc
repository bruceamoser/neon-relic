...
The DA notes the *base travel time* and the *Threat Level* of the journey (see Journey Threat below). If the team has the Field Intelligence Network HQ upgrade, they begin with one free piece of route intelligence.
